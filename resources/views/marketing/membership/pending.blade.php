    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md border border-[#27a2a2]/10">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('marketing.membership.registration') }}" class="px-4 py-2 bg-[#27a2a2] text-white rounded-md hover:bg-[#27a2a2]/80 transition-colors">Register New Member</a>
            </div>
