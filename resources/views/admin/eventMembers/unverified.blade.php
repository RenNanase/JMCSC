            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="mt-6 flex justify-between items-center">
                        ...
                        <a href="{{ route('admin.eventMembers.index') }}" class="inline-block px-4 py-2 bg-white border border-[#2cacad] text-[#2cacad] rounded hover:bg-[#2cacad] hover:text-white transition">Back to Pending Members</a>
                    </div>
                </div>
            </div>
        </div>
